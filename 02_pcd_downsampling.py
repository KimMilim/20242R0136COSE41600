...
sor_pcd = voxel_downsample_pcd.select_by_index(ind)

# Radius Outlier Removal (ROR) 적용
cl, ind = sor_pcd.remove_radius_outlier(nb_points=6, radius=1.0)
...
sor_pcd.paint_uniform_color([1, 0, 0])  # 빨강
ror_pcd.paint_uniform_color([0, 1, 0])  # 초록
...
visualize_point_clouds([original_pcd, sor_pcd], 
                       window_name="Original (Black), SOR (Blue)", point_size=2.0)

visualize_point_clouds([original_pcd, ror_pcd], 
